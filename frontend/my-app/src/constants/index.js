...
export const API_ENDPOINTS = {
  ...
  networkReceive: '/metrics/node_network_receive_bytes',
  diskUsagePercent: '/metrics/node_disk_usage_percent',
  memoryUsagePercent: '/metrics/node_memory_usage_percent',
  processCount: '/metrics/node_process_count',
  tags: '/tags',
  adminPanel: '/admin',
